export default {
  ...
  accounting: {
    ...
    noInstructorData: 'No instructor income data available',
    reports: 'Reports',
    reportFilters: 'Report Filters',
    ...
    instructorBreakdown: 'Instructor Breakdown',
  ...
  settings: {
    ...
    motto: 'Motto',
    mottoPlaceholder: 'Your inspiring motto here...',
    logo: 'Logo',
    logoHelp: 'Upload a logo (max 500KB, PNG or JPG)',
    logoTooLarge: 'Logo file is too large. Maximum size is 500KB.',
    ...
    backupDescription: 'Download a complete backup of all data in JSON format.',
    downloadBackup: 'Download Backup Now',
    ...
    printDescription: 'Generate printable reports and lists.',
    studentLists: 'Student Lists',
    studentListsDesc: 'Print all students with contact information.',
    printStudentList: 'Print Student List',
    classRosters: 'Class Rosters',
    classRostersDesc: 'Print class attendance rosters.',
    printClassRosters: 'Print Class Rosters',
    financialReports: 'Financial Reports',
    financialReportsDesc: 'Print payment and expense summaries.',
