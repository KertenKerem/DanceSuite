export default {
  ...
  users: {
    ...
    parentRequired: '18 yaşından küçük öğrenciler için zorunludur',
  ...
  attendance: {
    ...
    classSummary: 'Ders Özeti',
    studentSummary: 'Öğrenci Özeti',
  ...
  accounting: {
    ...
    exportPDF: 'PDF İndir',
    instructorBreakdown: 'Eğitmen Dökümü',
  ...
  settings: {
    ...
    backup: 'Yedekleme',
    print: 'Yazdır',
    schoolBranding: 'Okul Markası',
    schoolName: 'Okul Adı',
    motto: 'Slogan',
    mottoPlaceholder: 'İlham verici sloganınız...',
    logo: 'Logo',
    logoHelp: 'Logo yükleyin (maks. 500KB, PNG veya JPG)',
    logoTooLarge: 'Logo dosyası çok büyük. Maksimum 500KB.',
    ...
    backupMaintenance: 'Yedekleme ve Bakım',
    databaseBackup: 'Veritabanı Yedeği',
    backupDescription: 'Tüm verilerin tam yedeğini JSON formatında indirin.',
    downloadBackup: 'Yedeği Şimdi İndir',
    backupSuccess: 'Yedek başarıyla indirildi',
    exportData: 'Veri Aktar',
    exportUsers: 'Kullanıcıları Aktar',
    ...
    printDescription: 'Yazdırılabilir raporlar ve listeler oluşturun.',
    studentLists: 'Öğrenci Listeleri',
    studentListsDesc: 'İletişim bilgileriyle tüm öğrencileri yazdır.',
    printStudentList: 'Öğrenci Listesi Yazdır',
    classRosters: 'Sınıf Listeleri',
    classRostersDesc: 'Yoklama listelerini yazdır.',
    printClassRosters: 'Sınıf Listeleri Yazdır',
    financialReports: 'Finansal Raporlar',
    financialReportsDesc: 'Ödeme ve gider özetlerini yazdır.',
    printFinancialReport: 'Finansal Rapor Yazdır',
